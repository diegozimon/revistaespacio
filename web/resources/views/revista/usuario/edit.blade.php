	...
	<section class="content">
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				...
				<!--			<div class="form-group">
								<textarea name="resumen" class="form-control input-sm"  placeholder="Resumen">{{$usuario->resumen}}</textarea>
							</div> -->
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
							...
							<div class="form-group">
								<textarea name="autor" class="form-control input-sm" placeholder="Autor">{{$usuario->apellido}}</textarea>
							</div>
							<div class="row">

								<div class="col-xs-12 col-sm-12 col-md-12">
									<input type="submit"  value="Actualizar" class="btn btn-success btn-block">
									<a href="{{ route('revista.usuario.index') }}" class="btn btn-info btn-block" >Atrás</a>
								</div>	
